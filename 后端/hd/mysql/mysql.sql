...
(
    ...
    enroll_mode varchar(20) default 'REVIEW'          not null comment 'REVIEW/SECKILL',
    enroll_capacity int                               null comment 'seckill max seats',
    enroll_start_at datetime                          null comment 'seckill start time',
    enroll_end_at datetime                            null comment 'seckill end time',
    enroll_preheated_at datetime                      null comment 'last preheat time',
